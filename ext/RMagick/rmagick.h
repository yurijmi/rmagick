...
extern VALUE Image_morphology_bang(VALUE, VALUE, VALUE, VALUE);
extern VALUE Image_morphology_channel(VALUE, VALUE, VALUE, VALUE, VALUE);
extern VALUE Image_morphology_channel_bang(VALUE, VALUE, VALUE, VALUE, VALUE);
...
extern VALUE Image_level_colors_bang(int, VALUE *, VALUE);
...
extern VALUE Image_matte_flood_fill_bang(int, VALUE *, VALUE);
...
extern VALUE Image_negate_bang(int, VALUE *, VALUE);
...
extern VALUE Image_quantize_bang(int, VALUE *, VALUE);
...
extern VALUE Image_shadow_bang(int, VALUE *, VALUE);
...
extern VALUE Image_threshold_bang(VALUE, VALUE);
...
extern VALUE Image_transparent_bang(int, VALUE *, VALUE);
